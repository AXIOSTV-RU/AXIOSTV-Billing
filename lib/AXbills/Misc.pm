=head1 NAME
  ...
  AXbills::Misc - AXbills misc functions
...
#**********************************************************
=head2 load_module($modulename, $attr); - Load AXbills modules
...
sub form_purchase_module {
  ...
  if (!$@) {
    ...
    <a href='https://billing.axiostv.ru' target=_newa>AXbills</a>
    </p>
    <p>
    Purchase this module '$attr->{MODULE}'. </p>
    <p>
    For more information visit <a href='https://billing.axiostv.ru' target=_newa>AXbills</a>
    </p>
    </div>";
...
sub _function {
  ...
  if($@) {
    ...
    my $pid = $conf{HELP_DESK_PID} || 10000;
    my $issuetype = $conf{HELP_DESK_ISSUETYPE} || 10000;
    my $help_desk_login = $conf{HELP_DESK_LOGIN} || 'public_vers';

    print << "[END]";


<form action='https://support.billing.axiostv.ru/secure/CreateIssueDetails!init.jspa?'>
<input type=hidden name='reporter' value='$help_desk_login'>
<input type=hidden name='pid' value='$pid'>
<input type=hidden name='issuetype' value='$issuetype'>
<input type=hidden name='summary' value='$lang{error_in} $function_name'>
<input type=hidden name='description' value='$lang{help_error_text} \n =============== \n \n $@ \n =============== \n $lang{bil_vers} $version \n $lang{bil_funct_name} $function_name \n \n $lang{help_add_description} \n =============== \n \n'>
...
sub system_info {
  ...
  my $version     = get_version();
  my $request_url = 'https://billing.axiostv.ru/pages/viewpage.action?pageId=4358162';
