DROP TABLE IF EXISTS `NORSI_ABONENT`;
DROP TABLE IF EXISTS `NORSI_GATEWAY`;
DROP TABLE IF EXISTS `NORSI_IP_PLAN`;
DROP TABLE IF EXISTS `NORSI_PAYMENT`;
DROP TABLE IF EXISTS `NORSI_SUPPLEMENTARY_SERVICE`;
...
--
-- Структура таблицы `NORSI_ABONENT`
--

CREATE TABLE `NORSI_ABONENT` (
...
--
-- Структура таблицы `NORSI_GATEWAY`
--

CREATE TABLE `NORSI_GATEWAY` (
...
--
-- Структура таблицы `NORSI_IP_PLAN`
--

CREATE TABLE `NORSI_IP_PLAN` (
  `id` int(255) NOT NULL,
...
--
-- Структура таблицы `NORSI_PAYMENT`
--

CREATE TABLE `NORSI_PAYMENT` (
...
--
-- Структура таблицы `NORSI_SUPPLEMENTARY_SERVICE`
--

CREATE TABLE `NORSI_SUPPLEMENTARY_SERVICE` (
  `record_id` int(255) NOT NULL,
  `ID` int(10) NOT NULL,
  `BEGIN_TIME` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Индексы таблицы `NORSI_GATEWAY`
--
ALTER TABLE `NORSI_GATEWAY`
  ADD PRIMARY KEY (`record_id`);

--
-- Индексы таблицы `NORSI_IP_PLAN`
--
ALTER TABLE `NORSI_IP_PLAN`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `NORSI_PAYMENT`
--
ALTER TABLE `NORSI_PAYMENT`
...
--
-- AUTO_INCREMENT для таблицы `NORSI_GATEWAY`
--
ALTER TABLE `NORSI_GATEWAY`
  MODIFY `record_id` int(255) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `NORSI_IP_PLAN`
--
ALTER TABLE `NORSI_IP_PLAN`
