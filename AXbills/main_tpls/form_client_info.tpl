      ...
      <div class='card card-primary card-outline'>
        <div class='card-header border-0'>
          ...
          <div class='card-tools'>
            <button type='button' class='btn btn-success btn-xs %SHOW_ACCEPT_RULES%' data-toggle='modal'
        ...
        <div class='card-body p-0'>
          <table class='table table-bordered table-striped table-sm table-hover' width="100%">
            <tr>
              <td class='font-weight-bold text-left' width="35%">_{LOGIN}_</td>
              <td>%LOGIN% (UID: %UID%)</td>
            </tr>
            <tr>
              <td class='font-weight-bold text-left'>_{FIO}_</td>
              <td>%FIO%</td>
            <tr>
              <td class='font-weight-bold text-left'>_{ADDRESS}_</td>
              <td>%ADDRESS_STREET%, %ADDRESS_BUILD%/%ADDRESS_FLAT%/%ADDRESS_FLAT_ALT%</td>
            </tr>
			<!-- START AXbills -->
			%EXT_DATA_CP%
			%EXT_DATA_P%
            ...
            <tr class='%SHOW_REDUCTION%'>
              <td class='font-weight-bold text-left'>_{REDUCTION}_</td>
              <td>%REDUCTION% %</td>
            </tr>
            <tr class='%SHOW_REDUCTION%'>
              <td class='font-weight-bold text-left'>_{REDUCTION}_ _{DATE}_</td>
              <td>%REDUCTION_DATE%</td>
            </tr>
            <tr>
              <td class='font-weight-bold text-left'>_{CONTRACT}_</td>
              <td>
            ...
            <tr>
              <td class='font-weight-bold text-left'>_{CONTRACT}_ _{DATE}_</td>
              <td>%CONTRACT_DATE%</td>
            </tr>
            <tr>
              <td class='font-weight-bold text-left'>_{STATUS}_</td>
...
<script>
  ...
  //START AXbills
  let depositExtBlock = document.getElementById('ext_deposit');
  depositExtBlock.innerText = parseFloat(depositExtBlock.innerText).toFixed(2);

  if(parseFloat(depositExtBlock.innerText) > 0){
    depositExtBlock.classList.add('text-success');
    depositExtBlock.classList.remove('text-danger');
  }
  //END AXbills
