...
<form action=%SELF_URL% METHOD=post name=FORM_NAS>
  ...
  <div class='row'>
        ...
        <div class='card-body'>
                ...
                <div class='bd-highlight'>
                  <div class='input-group-append h-100'>
                    <a id='wiki-link' class='btn input-group-button rounded-left-0' data-tooltip='_{GUIDE_WIKI_LINK}_'
                       href='https://billing.axiostv.ru/?epkb_post_type_1_category=настройка-серверов-доступа' target='_blank'>?</a>
                    %WINBOX%
                  </div>
                </div>
              </div>
         ...
         <div class='form-group row'>
            <div class='col-md-6 custom-control custom-checkbox'>
              <input class='custom-control-input' type='checkbox' id='NAS_DISABLE' name='NAS_DISABLE' %NAS_DISABLE% value='1'>
              <label for='NAS_DISABLE' class='custom-control-label'>_{DISABLE}_</label>
            </div>

            <div class='col-md-6 custom-control custom-checkbox'>
              <input class='custom-control-input' type='checkbox' id='NAS_ACCIDENT_CHECK' name='NAS_ACCIDENT_CHECK' %NAS_ACCIDENT_CHECK% value='1'>
              <label for='NAS_ACCIDENT_CHECK' class='custom-control-label'>_{ACCIDENT_CHECK}_</label>
            </div>
          </div>
    ...
    <div class='col-md-6'>
      <div class='form-group'>
        <div class='card card-primary card-outline card-form-big'>
          ...
          <div id='nas_misc' class='card-collapse card-body collapse show'>
            %NAS_ID_FORM%
