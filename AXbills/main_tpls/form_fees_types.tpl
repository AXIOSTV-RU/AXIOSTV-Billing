  ...
  <form action='$SELF_URL' name=user class='form form-horizontal'>
    ...
    <div class='card card-primary card-outline card-form'>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-9">
            <div class="input-group">
              <input type='text' class='form-control' ID='ID' name='ID' value='%ID%' oninput='validateID()'>
            </div>
            <small id="id-error" style="color: red; display: none;">Максимальный ID 254</small>
          </div>
        </div>
      ...
      <div class='card-footer'>
        <input type=submit class='btn btn-primary' name='%ACTION%' value='%LNG_ACTION%' id='submit-button'>
      </div>
    </div>
  </form>
</div>
...
<script>
  function validateID() {
    ...
    const idValue = parseInt(idInput.value, 10);
