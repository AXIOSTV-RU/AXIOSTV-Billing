  ...
  <div class='card card-form card-outline card-primary'>
    ...
    <div class='card-body'>
      <div class='form-group row'>
        <label class='col-md-8 control-label'>_{BILL}_:</label>
        <div class='col-md-20 mx-auto'><b>№ %BILL_ID%</b></div>
        <div class='col-md-20 mx-auto'><b>_{COMPANY}_: %COMPANY_NAME%</b></div>
      </div>
      <div class='form-group row'>
