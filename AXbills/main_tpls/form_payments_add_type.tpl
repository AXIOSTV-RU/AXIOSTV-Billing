<form action=$SELF_URL METHOD=POST class='form-horizontal'>
  ...
  <div class='card card-primary card-outline card-form'>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-9">
          <div class="input-group">
            ...
            <div class="invalid-feedback">Максимальный ID 254</div>
          </div>
        </div>
      </div>
    ...
    <div class='card-footer'>
      <input class='btn btn-primary pull-center' id='submit-btn' name='%BUTTON_LABALE%' value='%BUTTON_NAME%' type='submit'>
    </div>
...
<script>
  jQuery(function () {
    ...
    jQuery('#NEW_ID').on('input', function () {
      var idValue = parseInt(this.value, 10);
      if (isNaN(idValue) || idValue >= 255) {
    ...
    }).trigger('input'); // Trigger input event to initialize state
  });
</script>
