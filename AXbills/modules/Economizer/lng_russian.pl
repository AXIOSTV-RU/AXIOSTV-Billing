...
$lang{INPUT_MONEY}='Введите оплаченную сумму';
...
$lang{SPENT_MONEY_FOR_PUB_UTILITIES_FOR_PERIODS}='Потраченные деньги на коммунальные услуги за периоды';
...
$lang{SALDO}='Сальдо';
$lang{ACCRUED}='Начислено';
$lang{PAID}='Оплачено';
$lang{REMAINDER}='Остаток';
$lang{VALUE_GRN}='Сумма, руб.';
$lang{DATA_FROM_ELECTRIC}='Данные с сайта oe.if.ua';
