...
$lang{DATE_ADD_INDICATOR}='The date of adding indicator';
...
$lang{DATA_FROM_ELECTRIC} ='Data from the site oe.if.ua';
$lang{RESOURSE_104} ='Data for the site 104.ua';
$lang{RESOURSE_ELECTRO} ='Data for https://oe.if.ua/';
$lang{SETTINGS_FORM} = "Customization form";
