...
$lang{ADD_ITEM} = 'Добавить тип работ';
...
$lang{YOURFINAL_SUM} = 'Сумма сложности';
...
$lang{CLOSED_TASKS} = 'количество работ, закрытых на Redmine';
...
$lang{SPRINT_REPORT} = 'Отчет по спринтам';
$lang{TASKS} = 'Все задачи';
$lang{AMOUNT_POINTS} = 'Сумма поинтов';
$lang{AVARAGE_POINT} = 'Средний поинт';
$lang{SUCCESS2} = 'Успешность';
$lang{PLAN} = 'план';
$lang{FACT} = 'факт';
