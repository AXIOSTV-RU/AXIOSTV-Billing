...
package Paysys::systems::YooKassa;
use strict;
...
sub get_settings {
  ...
  my %SETTINGS = (
    ...
    DOCS    => 'https://billing.axiostv.ru/pages/viewpage.action?pageId=5360690',
  );
...
sub user_portal {
  ...
  my $url = 'https://api.yookassa.ru/v3/payments';
