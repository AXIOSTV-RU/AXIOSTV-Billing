    ...
    <div class='card center-block container-md'>
        ...
        <div class='card-body'>
            ...
            <div class='form-group row'>
                ...
                <div class='col-sm-8 col-md-8'>
                    <div class='input-group'>
                        <input readonly id='LOGIN' name='LOGIN' value='%LOGIN%' %LOGIN_READONLY% required placeholder='_{LOGIN}_'
            ...
            <div class='form-group row'>
                ...
                <div class='col-sm-8 col-md-8'>
                    <div class='input-group'>
                        <input required id='FIO' name='FIO' value='%FIO%' required placeholder='_{FIO}_' class='form-control'
                               type='text'>
                    </div>
                </div>
            </div>
            ...
            <div class='form-group row'>
                ...
                <div class='col-sm-8 col-md-8'>
                    <input required id='PHONE' name='PHONE' value='%PHONE%' class='form-control' type='hidden'>
