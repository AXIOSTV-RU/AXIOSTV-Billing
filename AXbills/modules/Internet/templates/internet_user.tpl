  ...
  <div id='form_3' class='card card-primary card-outline card-big-form for_sort container-md pl-0 pr-0'>
    ...
    <div class='card mb-0 border-top card-outline card-big-form %IPOE_SHOW_BOX%'>
      ...
      <div class='card-body'>
       ...
       <div class='form-group row'>
         <label class='col-md-2 col-xs-4 col-form-label text-md-right' for='PORT_OPT82'>Option 82</label>
          <div class='input-group col-md-10 col-xs-8'>
            <input type='text' id='PORT_OPT82' name='PORT_OPT82' value='%PORT_OPT82%' class='form-control'/>
            <div class='input-group-append'>
      ...
      <div class='form-group row'>
        <label class='col-md-2 col-xs-4 col-form-label text-md-right' for='IPN_ACTIVATE'>_{ACTIVATE}_ IPN</label>
          <div class='col-md-4 col-xs-8 form-check d-flex align-items-center'>
            <input class='form-check-input' id='IPN_ACTIVATE' name='IPN_ACTIVATE' value='1' type='checkbox' %IPN_ACTIVATE%>
            %IPN_ACTIVATE_BUTTON%
          </div>

        <label class='col-md-2 col-xs-4 col-form-label text-md-right' for='PORT_FILL'>_{PORT_FILL_OPT82}_</label>
          <div class='col-md-4 col-xs-8 form-check d-flex align-items-center'>
            <input class='form-check-input' id='PORT_FILL' name='PORT_FILL' value='1' type='checkbox' %PORT_FILL%>
            %PORT_FILL_BUTTON%
          </div>
  ...
  jQuery(document).ready(function() {
      ...
      if (flagDateToday == 1) {
          ...
          if (selectedValue == 0) {
              ...
              jQuery("#SERVICE_ACTIVATE").val(currentDate);
          } else if ('%ACTION%' == 'change') {
              jQuery("#SERVICE_ACTIVATE").val('%SERVICE_ACTIVATE%');
          }
      }
