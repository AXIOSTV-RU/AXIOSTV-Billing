      ...
      <div class='card-body'>
        <div class='col-md-12'>
          ...
          <div class="form-group">
            <label class='control-label col-md-3' for='server'>AXbills server address</label>
            <div class='col-md-9'>
              <input name='server' value='%server%' class='form-control' type='text' placeholder='https://billing.axiostv.ru/'>
            </div>
          </div>
