<form action='$SELF_URL' method='post' class='form-horizontal'>
  ...
  <div class='card card-primary card-outline card-form'>
    ...
    <div class='card-body'>
      ...
      <div class='form-group row'>
        <label class='col-md-4 col-form-label text-md-right' for='CHANNEL_PRICE_MONTH'>_{CHANNEL_PRICE_MONTH}_:</label>
        <div class='col-md-8'>
          <input id='CHANNEL_PRICE_MONTH' name='CHANNEL_PRICE_MONTH' value='%CHANNEL_PRICE_MONTH%' placeholder='%CHANNEL_PRICE_MONTH%' class='form-control' type='number'>
        </div>
      </div>

      <div class='form-group row'>
        <label class='col-md-4 col-form-label text-md-right' for='CHANNEL_PRICE_DAY'>_{CHANNEL_PRICE_DAY}_:</label>
        <div class='col-md-8'>
          <input id='CHANNEL_PRICE_DAY' name='CHANNEL_PRICE_DAY' value='%CHANNEL_PRICE_DAY%' placeholder='%CHANNEL_PRICE_DAY%' class='form-control' type='number'>
        </div>
      </div>
