  ...
  <div class='card card-primary card-outline card-form'>
    ...
    <div class='card-body'>
      ...
      <div class='card collapsed-card'>
		...
		<div class='form-group row'>
            <label for='PROVIDER_ID' class='control-label col-md-3'>_{PROVIDER_ID}_:</label>
            <div class='col-md-9'>
              <input id='PROVIDER_ID' name='PROVIDER_ID' value='%PROVIDER_ID%' class='form-control' type='text'>
            </div>
          </div>
