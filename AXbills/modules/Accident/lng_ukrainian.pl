...
$lang{CHG_ACCIDENT} = 'Змінити аварію';
...
$lang{WARNING} = 'Увага!';
$lang{WARNING_ACCIDENT} = 'Проводяться аварійно-ремонтні роботи в районі. Просимо вибачення за незручності!';
...
$lang{ACC_STATUS_OPEN} = 'Відкрита';
$lang{ACC_STATUS_CLOSED} = 'Закрита';
