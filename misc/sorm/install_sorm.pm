...
if ($arg eq 'mfi') {
    ...
    copy('/usr/axbills/misc/sorm/mfi/Sorm.pm', '/usr/axbills/AXbills/mysql/Sorm.pm') or die "Copy failed: $!";
} elsif ($arg eq 'norsi') {
    ...
    copy('/usr/axbills/misc/sorm/norsi/Sorm.pm', '/usr/axbills/AXbills/mysql/Sorm.pm') or die "Copy failed: $!";
} else {
