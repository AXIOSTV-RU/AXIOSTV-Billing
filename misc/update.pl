...
=head2 check_used_perl_modules()
  ...
  Reads list of modules needed for normal using AXbills
...
sub _get_support_credentials {
  ...
  if (!$OPTIONS{USERNAME} || !$OPTIONS{PASSWORD}) {
    ...
    say "Please enter your AXbills Support login and password for server registration ($tries_left)";
