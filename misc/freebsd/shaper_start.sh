#!/bin/sh
# Shaper/NAT/Session upper for AXbills
#
...
#
#   axbills_shaper_if="" - AXbills shapper interface default ng*
#
#   axbills_nas_id="" - AXbills NAS ID default 1
#
...
#
#   axbills_ipn_nas_id="" AXbills IPN NAS ids, Enable IPN firewall functions
#
