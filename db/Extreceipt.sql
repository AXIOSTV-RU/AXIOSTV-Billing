...
CREATE TABLE IF NOT EXISTS `extreceipts_kkt` (
  ...
  `check_header` VARCHAR(100)          NOT NULL DEFAULT '',
  `check_desc`   VARCHAR(100)          NOT NULL DEFAULT '',
  `check_footer` VARCHAR(100)          NOT NULL DEFAULT '',
  ...
  `admins`       VARCHAR(200)          NOT NULL DEFAULT '',
