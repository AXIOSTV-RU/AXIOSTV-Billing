...
--   PRIMARY KEY (`id`),
--   KEY `uid` (`uid`)
-- ) ENGINE=InnoDB AUTO_INCREMENT=129 DEFAULT CHARSET=utf8mb4 COMMENT='Callcenter ivr log';
...
--   `musiconhold` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
--   `message` varchar(20) DEFAULT NULL,
--   `announce` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--   `monitor_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
--   `monitor_format` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
--   `queue_youarenext` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
--   `queue_thereare` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
--   `queue_callswaiting` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
--   `queue_holdtime` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
--   `queue_minutes` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
--   `queue_seconds` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
--   `queue_lessthan` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
--   `queue_thankyou` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
--   `queue_reporthold` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
--   `announce_frequency` tinyint(2) DEFAULT NULL,
--   `announce_round_seconds` int(11) DEFAULT NULL,
--   `announce_holdtime` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
--   `announce_position` varchar(10) DEFAULT NULL,
--   `retry` tinyint(2) DEFAULT NULL,
--   `wrapuptime` int(11) DEFAULT NULL,
--   `maxlen` int(11) DEFAULT NULL,
--   `servicelevel` int(11) DEFAULT NULL,
--   `strategy` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
--   `joinempty` varchar(100) DEFAULT NULL,
--   `leavewhenempty` varchar(100) DEFAULT NULL,
--   `eventmemberstatus` tinyint(1) DEFAULT NULL,
--   `eventwhencalled` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
--   `reportholdtime` varchar(5) DEFAULT NULL,
--   `memberdelay` int(11) DEFAULT NULL,
--   `weight` int(11) DEFAULT NULL,
--   `timeoutrestart` tinyint(1) DEFAULT NULL,
--   `periodic_announce` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
