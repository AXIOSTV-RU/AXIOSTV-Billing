...
CREATE TABLE IF NOT EXISTS `equipment_vendors` (
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT = 'Netlist equipment vendor';
...
CREATE TABLE IF NOT EXISTS `equipment_ports` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Equipment ports';
...
CREATE TABLE IF NOT EXISTS `pon_onus` (
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT = 'PON onu list';
...
CREATE TABLE IF NOT EXISTS `equipment_box_types` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Equipment box types';
...
CREATE TABLE IF NOT EXISTS `equipment_boxes` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Equipment boxes';
...
CREATE TABLE IF NOT EXISTS `equipment_vlans` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Equipment vlans';
...
CREATE TABLE IF NOT EXISTS `equipment_extra_ports` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Table for extra ports for equipment models';
...
CREATE TABLE IF NOT EXISTS `equipment_traps` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Equipment traps';
...
CREATE TABLE IF NOT EXISTS `equipment_backup` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Equipment backup description';
...
CREATE TABLE IF NOT EXISTS `equipment_graphs` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Equipment graph stats';
...
CREATE TABLE IF NOT EXISTS `equipment_graph_log` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Equipment graph stats log';
...
CREATE TABLE IF NOT EXISTS `equipment_mac_log` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Equipment MAC log';
...
CREATE TABLE IF NOT EXISTS `equipment_pon_onu` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Equipment ONU';
...
CREATE TABLE IF NOT EXISTS `equipment_pon_ports` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Equipment PON ports';
...
CREATE TABLE IF NOT EXISTS `equipment_trap_types` (
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT = 'Equipment trap types';
...
CREATE TABLE IF NOT EXISTS `equipment_snmp_params` (
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT = 'Equipment snmp params list';
...
CREATE TABLE IF NOT EXISTS `equipment_ping_log` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Equipment ping';
...
CREATE TABLE IF NOT EXISTS `equipment_tr_069_settings` (
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT = 'Equipment TR-069 Settings';
...
CREATE TABLE IF NOT EXISTS `equipment_calculator`(
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Equipment calculator';
