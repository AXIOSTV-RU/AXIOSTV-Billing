DROP TABLE IF EXISTS `SPECTECH_ABONENT`;
DROP TABLE IF EXISTS `SPECTECH_GATEWAY`;
DROP TABLE IF EXISTS `SPECTECH_IP_PLAN`;
DROP TABLE IF EXISTS `SPECTECH_PAYMENT`;
DROP TABLE IF EXISTS `SPECTECH_SUPPLEMENTARY_SERVICE`;
...
--
-- Структура таблицы `SPECTECH_ABONENT`
--

CREATE TABLE `SPECTECH_ABONENT` (
...
--
-- Структура таблицы `SPECTECH_GATEWAY`
--

CREATE TABLE `SPECTECH_GATEWAY` (
...
--
-- Структура таблицы `SPECTECH_IP_PLAN`
--

CREATE TABLE `SPECTECH_IP_PLAN` (
  `id` int(255) NOT NULL,
...
--
-- Структура таблицы `SPECTECH_PAYMENT`
--

CREATE TABLE `SPECTECH_PAYMENT` (
...
--
-- Структура таблицы `SPECTECH_SUPPLEMENTARY_SERVICE`
--

CREATE TABLE `SPECTECH_SUPPLEMENTARY_SERVICE` (
  `record_id` int(255) NOT NULL,
  `ID` int(10) NOT NULL,
  `MNEMONIC` varchar(12) NOT NULL,
  `BEGIN_TIME` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Индексы таблицы `SPECTECH_GATEWAY`
--
ALTER TABLE `SPECTECH_GATEWAY`
  ADD PRIMARY KEY (`record_id`);

--
-- Индексы таблицы `SPECTECH_IP_PLAN`
--
ALTER TABLE `SPECTECH_IP_PLAN`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `SPECTECH_PAYMENT`
--
ALTER TABLE `SPECTECH_PAYMENT`
...
--
-- AUTO_INCREMENT для таблицы `SPECTECH_GATEWAY`
--
ALTER TABLE `SPECTECH_GATEWAY`
  MODIFY `record_id` int(255) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `SPECTECH_IP_PLAN`
--
ALTER TABLE `SPECTECH_IP_PLAN`
