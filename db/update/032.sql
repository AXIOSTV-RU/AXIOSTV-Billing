...
CREATE TABLE IF NOT EXISTS `users_contracts` (
  ...
  `signature` TEXT,
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Contracts';

ALTER TABLE equipment_mac_log ADD COLUMN port_name VARCHAR(50) NOT NULL DEFAULT '';
ALTER TABLE equipment_mac_log CHANGE COLUMN port port VARCHAR(50) COLLATE utf8mb4_general_ci DEFAULT '';
