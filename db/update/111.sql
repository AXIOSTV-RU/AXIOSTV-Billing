CREATE TABLE IF NOT EXISTS `crm_competitors` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Crm Competitors';
...
CREATE TABLE IF NOT EXISTS `crm_competitors_tps` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Crm Competitors tps';
...
CREATE TABLE IF NOT EXISTS `crm_competitor_geolocation` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Geolocation of competitor';
...
CREATE TABLE IF NOT EXISTS `crm_competitor_tps_geolocation` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Geolocation of competitor tps';
...
CREATE TABLE `payments_spool` (
  ...
  KEY `uid` (`uid`),
  KEY `ext_id` (`ext_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='Payments log spool';
