...
CREATE TABLE IF NOT EXISTS `iptv_main` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Iptv users settings';
...
CREATE TABLE IF NOT EXISTS `iptv_tps` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Iptv TPs';
...
CREATE TABLE IF NOT EXISTS `iptv_channels` (
  ...
  `channel_price_month` varchar(10) NOT NULL DEFAULT '0',
  `channel_price_day` varchar(10) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
  UNIQUE KEY `num` (`num`)
)
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Iptv channels';
...
CREATE TABLE IF NOT EXISTS `iptv_ti_channels` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Iptv channels prices';
...
CREATE TABLE IF NOT EXISTS `iptv_users_channels` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Iptv users channels';
...
) DEFAULT CHARSET=utf8mb4 COMMENT = 'Iptv online';
...
CREATE TABLE IF NOT EXISTS `iptv_subscribes` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Iptv Subscribes';
...
CREATE TABLE IF NOT EXISTS `iptv_screens` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'IPTV Extra screens';
...
CREATE TABLE IF NOT EXISTS `iptv_services` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'IPTV Services';
...
CREATE TABLE IF NOT EXISTS `iptv_devices` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'IPTV devices';
...
CREATE TABLE IF NOT EXISTS `iptv_extra_params` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'IPTV extra_params';
