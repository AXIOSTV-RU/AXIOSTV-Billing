...
CREATE TABLE IF NOT EXISTS `poll_polls` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Table for polls';
...
CREATE TABLE IF NOT EXISTS `poll_answers` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Table for polls answers';
...
CREATE TABLE IF NOT EXISTS `poll_votes` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Table for votes';
...
CREATE TABLE IF NOT EXISTS `poll_discussion` (
  ...
  DEFAULT CHARSET=utf8mb4 COMMENT = 'Table for discussion';