...
CREATE TABLE IF NOT EXISTS `internet_online` (
  ...
  KEY `acct_session_id` (`acct_session_id`),
  UNIQUE KEY `framed_ip_address` (`framed_ip_address`),
...
CREATE TABLE IF NOT EXISTS `nas` (
  ...
  `accident_check` tinyint(1)           NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `trafic_tarifs` (
  ...
  `burst_time_dl`      INT(10) UNSIGNED       NOT NULL DEFAULT 0,
  `burst_time_ul`      INT(10) UNSIGNED       NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `users_pi` (
  ...
  `fio1`           VARCHAR(40)          NOT NULL DEFAULT '',
  `fio2`           VARCHAR(40)          NOT NULL DEFAULT '',
  `fio3`           VARCHAR(40)          NOT NULL DEFAULT '',
  `company_name`   VARCHAR(100)         NOT NULL DEFAULT '',
  `inn`            BIGINT(12) UNSIGNED  NOT NULL DEFAULT 0,
  `kpp`            INT(9) UNSIGNED      NOT NULL DEFAULT 0,
  `ogrn`           BIGINT(13) UNSIGNED  NOT NULL DEFAULT 0,
  `okpo`           VARCHAR(8)           NOT NULL DEFAULT '',
  `bank_bic`       VARCHAR(10)          NOT NULL DEFAULT '',
  `bank_name`      VARCHAR(150)         NOT NULL DEFAULT '',
  `bank_account`   VARCHAR(25)          NOT NULL DEFAULT '',
  `cor_bank_account` VARCHAR(25)        NOT NULL DEFAULT '',
  `phone`          VARCHAR(16)          NOT NULL DEFAULT '',
  `email`          VARCHAR(250)         NOT NULL DEFAULT '',
  `country_id`     SMALLINT(6) UNSIGNED NOT NULL DEFAULT '0',
  `address_street` VARCHAR(100)         NOT NULL DEFAULT '',
  `address_build`  VARCHAR(10)          NOT NULL DEFAULT '',
  `address_flat`   VARCHAR(10)          NOT NULL DEFAULT '',
  `address_flat_alt` VARCHAR(40)        NOT NULL DEFAULT '',
  `comments`       TEXT                 NOT NULL,
  ...
  `citizenship`    VARCHAR(1)           NOT NULL DEFAULT '1',
  `pasport_num`    VARCHAR(20)          NOT NULL DEFAULT '',
  `pasport_series` varchar(10)          NOT NULL DEFAULT '',
  `pasport_number` varchar(10)          NOT NULL DEFAULT '',
  `pasport_code`   TEXT                 NOT NULL,
  `pasport_date`   DATE                 NOT NULL DEFAULT '0000-00-00',
  `pasport_grant`  VARCHAR(255)         NOT NULL DEFAULT '',
...
INSERT INTO `admins` (`id`, `name`, `regdate`, `password`, `gid`, `aid`, `disable`, `phone`, `web_options`, `comments`, `pasport_date`, `birthday`, `start_work`
  ...
  ('axbills', 'АСР AXBills', curdate(), ENCODE('axbills', 'test12345678901234567890'), 0, 1, 0, '', '', '', '2023-10-01',
   '2023-10-01', NOW());
INSERT INTO `admins` (`id`, `name`, `regdate`, `password`, `gid`, `aid`, `disable`, `phone`, `web_options`, `comments`, `pasport_date`, `birthday`, `start_work`)
VALUES ('system', 'System user', curdate(), ENCODE(md5(RAND()), 'test12345678901234567890'), 0, 2, 0, '', '', '',
                  '2023-10-01', '2023-10-01', NOW());
INSERT INTO `admins` (`id`, `name`, `regdate`, `password`, `gid`, `aid`, `disable`, `phone`, `web_options`, `comments`, `pasport_date`, `birthday`, `start_work`)
VALUES
...
INSERT INTO `users` (`id`, `activate`, `expire`, `credit`, `reduction`, `registration`, `password`, `uid`, `gid`, `disable`, `bill_id`, `ext_bill_id`, `credit_date`, `domain_id`)
VALUES
...
REPLACE INTO `fees_types` (`id`, `name`) VALUES (1, '$lang{ABON}'), (2, '$lang{FINE}'), (3, '$lang{ACTIVATE}'), (4, '$lang{MONEY_TRANSFER}'), (5, '$lang{CREDIT}'), (6, '$lang{INTERNET}'), (0, '$lang{ONE_TIME}');
