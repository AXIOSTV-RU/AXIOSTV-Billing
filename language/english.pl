...
$lang{GUIDE_WELCOME_TEXT} = 'Welcome to AXbills. This guide will show you main interface features.';
...
$lang{DAYS_2} = 'days';
$lang{HOLDUP_PERIOD_NOT_EXPIRE} = 'The suspension service is not available — the period between services has not ended';
$lang{HOLDUP_MIN_PERIOD_NOT_EXPIRE} = 'Cancellation of the suspension is not available — the minimum service period has not ended';
$lang{EXTRA_DEPOSIT}= 'Ext. deposit';

$lang{PORT_FILL_OPT82} = 'Fill NAS/Port';
